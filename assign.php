...
<html lang="en">
  <head>
    ...
    <title>eps32 Add Greenhouse</title>
...
$result=mysqli_query($con,"SELECT * FROM user WHERE role=2");
 while($row2=mysqli_fetch_assoc($result)){  ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                             <select name="building_id" class="form-control select2" required="">
                            <option value="">Select Building</option>
                       <?php include 'connection.php';
$result2=mysqli_query($con,"SELECT * FROM building");
                     ...
                     <?php   }?>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success" name="assign_building">Submit</button>
                        </div>
                      </div>
